...
<html <?php language_attributes(); ?>>
   <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, minimum-scale=1.00, user-scalable=yes">
   ...
   <body <?php body_class(); ?>>
      ...
      <div id="page" class="site">
        <a href="https://www.awwwards.com/sites/wukiyo-r" target="_blank">
          <img src="<?php echo get_template_directory_uri();?>/img/awwwards-honor-banner.svg" id="awwwards" alt="Awwwards Honor banner">
        </a>
                ...
                <div class="header-container white-border-bottom position-relative">
                    ...
                    ?>
                      ...
                      <a href="<?php echo get_home_url(); ?>">
                        <img class="header-logo" src="<?php echo get_template_directory_uri(); echo $logo?>" alt="Everything you can be">
                      </a>
