	...
	<div class="carousel slide carousel-fade" id="carouselExampleIndicators" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				...
				data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/1.webp" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/2.webp" 
				data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/2.webp" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/3.webp"
				data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/3.webp" alt="Third slide">
			</div>
			<div class="carousel-item">
				<img class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/4.webp"
				data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/esse/4.webp" alt="Fourth slide">
			</div>
		</div>
	...
	<div class="summary entry-summary">
					...
					<div class="product-testimonial">
						...
						<div class="product-testimonial-text">
							...
							<p>"Love it! Everything in this has been provided and tested to increase mental acuteness. 
								I might as well have superpowers because it allows me to have such a new outlook on how I get my tasks done. 
								Truly a game changer product if you want to heighten awareness and increase mood ten-fold. 
								The shot of joy typically comes within 30 minutes of taking this on on empty stomach and lasts well throughout the day with no crash or jittery feeling."
							</p>
						</div>
					</div>	
				</div>
				<div class="col-md">
					<div class="product-testimonial">
						...
						<div class="product-testimonial-text">
							...
							MD <br>
							<p>"WUKIYO | esse™ delivers the most comprehesive supplementation available in any nootropic stack I have seen. 
								It is designed to deliver meaningful improvements to overall cognitive function. 
								In addition to immediate neurochemical and physiological effects, goes a step further addressing long-term cognitive health benefits, 
					...
					<div class="product-testimonial">
						...
						<div class="product-testimonial-text">
							...
							<p>"For me this product made me feel alert and aware. 
								My mind felt clutter-free, I am able to focus on topics and feelings with a simple thinking process. 
		...
		<div class="product-certificates-wrapper">
			...
			<div class="product-cert">
				...
				<p class="cert-text mb-0">NSF International verifies that products meet public health and safety standards. WUKIYO | esse™ passed with flying colors.</p>
			</div>
			<div class="product-cert">
				<div class="cert-img-2">
					<img src="<?php echo get_template_directory_uri(); ?>/img/fda-compliant@2x.webp" alt="FDA Logo">
				</div>
				<p class="cert-text mb-0">The Food and Drug Administration (FDA) regulates the safety of food, drugs, and other consumer products. WUKIYO | esse™ fits the bill.</p>
			</div>
			<div class="product-cert">
				<div class="cert-img-3">
					<img src="<?php echo get_template_directory_uri(); ?>/img/WADA@2x.webp" alt="WADA Logo">
				</div>
				<p class="cert-text mb-0">The World Anti-Doping Agency (WADA) monitors the fight against drugs in sports. WUKIYO | esse™ can keep you in the zone and in the game.</p>
			</div>
		</div>
		...
		<div class="product-ingredients-wrapper">
			...
			<div class="product-ingredients-header d-flex align-items-center">
				<img alt="Product logo" class="mr-3 logo300" src="<?php echo get_template_directory_uri(); ?>/img/logos/wukiyo-esse.svg">
				<h3>Ingredients</h3>
			</div>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p class="product-accordion-p">Alpha-GPC administration increases the release of the neurotransmitter acetylcholine and facilitates learning and memory. 
						In athletes, Alpha-GPC supplementation prevents exercise-induced reductions in choline levels, increases endurance performance and growth hormone secretion.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p class="product-accordion-p">The original novel nootropic and neuroprotective agent FL66™. 
						Although the exact mechanism of action has yet to be fully elucidated, FL66™ appears to inhibit the reuptake of dopamine by binding to the dopamine-reuptake pump, 
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p class="product-accordion-p">Some of the important functions folate aides in are the creation of DNA and RNA, formation of neurotransmitters, and the formation of the nervous system during pregnancy. 
			...
			<div class="single-product-accordion">
				<div class="m-0 toggleAccordion ingredient">
					<p class="m-0 d-flex align-items-center">Organic Lion's Mane<span class="ingredient-quantity">600 mg</span></p>
				</div>
				<div class="hidden">
					<p class="product-accordion-p">Research has found that lion's mane may protect against dementia, reduce mild symptoms of anxiety and depression and help repair nerve damage. 
			...
			<div class="single-product-accordion">
				<div class="m-0 toggleAccordion ingredient">
					<p class="m-0 d-flex align-items-center">CoEnzyme Q10<span class="ingredient-quantity">100 mg</span></p>
				</div>
				<div class="hidden">
					<p class="product-accordion-p">The present results show that oral administration of CoEnzyme Q10 increases brain mitochondrial concentrations and produces neuroprotective effects. 
			...
			<div class="single-product-accordion">
				<div class="m-0 toggleAccordion ingredient">
					<p class="m-0 d-flex align-items-center">L-Theanine<span class="ingredient-quantity">100 mg</span></p>
				</div>
				<div class="hidden">
					<p class="product-accordion-p">L-theanine promotes relaxation and facilitates sleep by contributing to a number of changes in the brain: Boosts levels of GABA and other calming brain chemicals. 
			...
			<div class="single-product-accordion">
				<div class="m-0 toggleAccordion ingredient">
					<p class="m-0 d-flex align-items-center">Natural Caffeine<span class="ingredient-quantity">90 mg</span></p>
				</div>
				<div class="hidden">
					<p class="product-accordion-p">Natural Caffeine can improve mood and help people feel more productive. 
						It is believed to work by blocking the neurotransmitter adenosine's receptors, increasing excitability in the brain.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				<div class="m-0 toggleAccordion ingredient">
					<p class="m-0 d-flex align-items-center">Vitamin B1, B6, B12<span class="ingredient-quantity">100mg, 15mg, 1000mcg</span></p>
				</div>
				<div class="hidden">
					<p class="product-accordion-p">Vitamins B1, B6 and B12 influence the brain process and development by helping with the development of neurotransmitters. 
		...
		<div class="product-qa-wrapper">
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p class="product-accordion-p">WUKIYO® | esse is the evolution of nootropics supplements, a world's first genetically engineered nootropics formulation, with a high-efficiency capsule delivery system for its branded ingredients.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>It takes 6 capsules and as little as 30 minutes to enter a realm of mental clarity and enhanced focus.</p>
					<p>In this heightened mental state, your reactions are faster, your focus clearer, your awareness heightened.</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>The primary ingredients of the WUKIYO® | esse formula are the researched chemicals W-sensei and W-komorai.</p>
					<p>Both are pharmacologically active biochemicals discovered by W-YO during neuroscientific research of biochemical pathways.</p>
					...
					<ul class="list">
						...
						<li>fluorobenzhydrol 4 (by condensation of grignard reagent 2 with fluorobenzaldehyde 3 or ethyl formate 10)</li>
					...
					<ul class="list">
						...
						<li>cross-linked sodium carboxymethyl cellulose from about 1-10% of the composition by weight</li>
					...
					<p>The objective of the invention is to expand the arsenal of tools that improve microvascularization in brain tissue. The problem is solved by the use of W-sensei and W-komorai as a means of improving microvascularization in brain tissue. W-sensei has neuroprotective, atioxidant cardioprotective and antihypoxic activity, as well as antiarrhythmic, antiplatelet, antithrombotic and antithrombogenic properties. The use of W-sensei as a means of improving microvascularization in brain tissue is not described in the literature. Fundamentally new in the present invention is that as a means of improving microvascularization in brain tissue, W-sensei is used. This type of activity of W-sensei does not explicitly follow from the prior art. W-sensei can be used in the complex therapy of pathologies accompanied by impaired microvascularization in brain tissue in cases of cerebrovascular accident. Thus, this technical solution meets the criteria of the invention: "novelty", "inventive step", "industrial applicability".</p>
					<p class="bold">Legal aspects</p>
					<p>Since the market is governed by multinational giants in the pharmaceutical industry, which impose high regulatory barriers to entry, we seek to create products that comply with demanding health-safety regulations and which seek to address the demands of consumers and institutions, creating a products which foregoes the best available tests in an laboratoric environment.</p>
					<p>We implore our customers to employ our products responsibly in their intended research application, taking all necessary safety precautions given that many of them have a substantial lack of scientific data regarding potential adverse effects on humans.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					...
					<p>as a dietary supplement, take one aluminium bottle packet (6 capsules) in the morning or early afternoon, preferably with a light meal or snack.</p>
					<p>Drink plenty of water throughout the day to boost supplement absorption and avoid dehydration.</p>
					<p>By design, the aluminium bottles are numbered in a sequence from 1 to 6. Since all the bottles contain the same ingredients, you may consume the product in any order of your choosing.</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>Most people will start to experience the benefits of WUKIYO® | esse within 30 - 45 minutes of taking it. The effects build over time and become considerably more pronounced after 2 hours.</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>WUKIYO® | esse can be stored anywhere (in your car, backpack, purse or desk), but we recommend a cool, dry place and out of the reach of children.</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>We recommend you avoid taking any other stimulants with WUKIYO® | esse at first, to see how you respond to WUKIYO® | esse alone. Depending on the individual, some people may be able to use our products in combination with other stimulants.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					...
					<p>Consult with your doctor before taking WUKIYO® | esse. This may be especially important if you have health concerns or are taking medications. Interactions are always possible.</p>
		...
		<div class="product-reviews-wrapper">
			...
			<img alt="Product logo" class="logo300" src="<?php echo get_template_directory_uri(); ?>/img/logos/wukiyo-esse.svg">
