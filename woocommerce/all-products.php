        ...
        foreach ($product_ids as $product_name => $product_id) {
            ...
            <div id="<?php echo $card_id; ?>" class="<?php echo $column_class; ?> col-xl product-card">
                <div class="product-card-inner-wrapper" data-productid="<?php echo $product_id; ?>">
                    <span class="remove-product-added-desktop hidden"><img
                            src="<?php echo get_template_directory_uri(); ?>/img/x-close-grey.svg"
                            alt="remove effect"></span>
                    <span class="remove-product-added-mobile hidden"><img
                            src="<?php echo get_template_directory_uri(); ?>/img/x-close-black.svg"
                            alt="remove effect"></span>
                    <img class="product-logo" src="<?php echo get_template_directory_uri();
                    echo $product_logo_src; ?>" alt="Product logo">
                    <div class="first-half-wrapper">
                        <img class="product-package" src="<?php echo get_template_directory_uri();
                        echo $product_package_src; ?>" alt="Product package">
                        <div class="quantity_buttons_wrapper hidden">
                            <div class="add-to-cart-button">
                                <!-- TODO - refaktorisi - input field -->
                                <div data-productid="<?php echo $product_id; ?>" data-operator="remove"
                                    class="remove remove-final-archive"
                                    data-cart-item-key="<?php echo $product_cart_item_key; ?>">-</div>
                                <div class="numberOfProducts product-quantity-<?php echo $product_id; ?> fontBold">
                                    <?php echo $product_current_quantity; ?>
                                </div>
                                <div data-productid="<?php echo $product_id; ?>" data-operator="add"
                                    class="add add-final-archive"
                                    data-cart-item-key="<?php echo $product_cart_item_key; ?>">+</div>
                            </div>
                        </div>
                    </div>
                    <div class="second-half-wrapper">
                        <div class="helper-wrapper-desktop">
                            ...
                            <div class="buytwo-price-wrapper">
                                ...
                                <p
                                    class="product_price <?php echo esc_attr(apply_filters('woocommerce_product_price_class', 'price')); ?>">
                        ...
                        <button id="add-to-cart-<?php echo $product_id; ?>" class="archive-add-to-cart-button archive-single-add-to-cart-button <?php if (!$is_in_stock) {
                               echo 'disabled';
                           } ?>" data-productid="<?php echo $product_id; ?>"><span
                                class="bold"><?php echo $is_in_stock ? 'ADD TO CART' : 'OUT OF STOCK' ?></span></button>
                    </div>
                </div>
            </div>
            <?php
