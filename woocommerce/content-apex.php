		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img id="target" class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/1.webp"
					data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/1.webp"
					alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/2.webp"
					data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/2.webp"
					alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/3.webp"
					data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/3.webp"
					alt="Third slide">
			</div>
			<div class="carousel-item">
				<img class="target" src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/4.webp"
					data-magnify-src="<?php echo bloginfo('template_url'); ?>/img/carousel/apex/4.webp"
					alt="Fourth slide">
			</div>
		</div>
	...
	<div class="summary entry-summary">
		...
		<div class="product-ingredients-wrapper">
			...
			<div class="product-ingredients-header d-flex align-items-center">
				<img alt="Product logo" class="mr-3 logo300"
					src="<?php echo get_template_directory_uri(); ?>/img/logos/wukiyo-apex.svg">
				<h3>Ingredients</h3>
			</div>
		...
		<div class="product-qa-wrapper">
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>WUKIYO® | apex is the evolution of nootropics supplements, a world's first genetically
						...
						WUKIYO® | apex functions as a whole-brain optimiser to support a state of peak overall mental
						performance.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>It takes one tablet and as little as 30 minutes to enter a realm of mental clarity and enhanced
						focus.
						In this heightened mental state, your reactions are faster, your focus clearer, your awareness
						heightened.
						You're more productive, more efficient, you can push the limits and transcend the boundaries.
					</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>The primary ingredients of the WUKIYO® | apex formulation are the researched chemicals CRL-21X™
						and FL66™. Both are pharmacologically active biochemicals discovered by W-YO® during
						neuroscientific research of biochemical pathways.</p>
					<p>W-YO® has been awarded a Notice of Allowance from the United States Patent and Trademark Office
						for our two proprietary nootropic molecules CRL-21X™ and FL66™.</p>
					<p>The objective of the invention is to expand the arsenal of tools that improve
						microvascularization in brain tissue. The problem is solved by the use of CRL-21X™ and FL66™ as
						a means of improving microvascularization in brain tissue. Both chemicals have neuroprotective,
						antioxidant cardioprotective and antihypoxic activity, as well as antiarrhythmic, antiplatelet,
						antithrombotic and antithrombogenic properties.</p>
					<p>CRL-21X™ and FL66™ can be used in the complex therapy of pathologies accompanied by impaired
						microvascularization in the brain tissue. Thus, this technical solution meets the criteria of
						the invention: "novelty", "inventive step", "industrial applicability". </p>
					<p>Legal aspects</p>
					<p>Since the market is governed by multinational giants in the pharmaceutical industry, which impose
						...
						creating a products which foregoes the best available tests in a laboratory environment.</p>
					<p>If you are interested in joining our team, where passion and belief in a worthy cause are
						celebrated and supported, please do contact us. We are always pleased to hear from talented and
						dedicated people, just like you, to join us and help make a real difference.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					...
					<p>As a dietary supplement, take one tablet in the morning or early afternoon, with or without food.
					</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>Take WUKIYO® | apex whenever you need a boost towards your desired state of mind.
						Prior to an important meeting, a pitch, getting started on an important project, practicing or
						performing, studying, taking an exam, playing sports, etc.</p>
				</div>
			</div>
			<div class="black-border-bottom"></div>
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>Most people will start to experience the benefits of WUKIYO® | apex within 30 - 45 minutes of
						taking it. The effects build over time and become considerably more pronounced after two hours.
					</p>
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>WUKIYO® | apex can be stored anywhere (in your car, backpack, purse or desk), but we recommend a
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					<p>We recommend you avoid taking any other high potency stimulants with WUKIYO® | apex at first, to
						see how you respond to WUKIYO® | apex alone.
			...
			<div class="single-product-accordion">
				...
				<div class="hidden">
					...
					<p>Consult with your doctor before taking WUKIYO® | apex. This may be especially important if you
