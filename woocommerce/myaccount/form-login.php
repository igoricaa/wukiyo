...
<form class="woocommerce-form woocommerce-form-login login" method="post">
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label class="my-account-field-label" for="password"><?php esc_html_e('Password', 'woocommerce'); ?>&nbsp;<span
				class="required">*</span></label>
		<input class="my-account-field-input woocommerce-Input woocommerce-Input--text input-text" type="password"
	...
	<p class="form-row">
		...
		<button type="submit" class="button-font woocommerce-button button woocommerce-form-login__submit" name="login"
