...
?>
<div>	
	<p class="mb-0"><span>Order Date: </span><time datetime="<?php echo esc_attr( $order_date -> date( 'Y-m-d' ) ); ?>" title="<?php echo esc_attr( $order_date->getTimestamp() ); ?>"><?php echo wp_kses_post( $order_date->date_i18n( wc_date_format() ) ); ?></time></p>
	<p class="mb-0"><span>Status: </span><?php echo esc_html( wc_get_order_status_name( $order -> get_status() ) ); ?></p>
