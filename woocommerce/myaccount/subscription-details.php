...
<div>
	<p class="mb-0"><span>Start date:
		</span><?php echo esc_html($subscription->get_date_to_display('start_date')); ?></p>
	<p class="mb-0"><span>Last order date:
		</span><?php echo esc_attr($subscription->get_date_to_display('last_order_date_created')); ?></p>
	<p class="mb-0"><span>Next payment date:
		</span><?php echo esc_attr($subscription->get_date_to_display('next_payment')); ?></p>
	...
	if (!empty($actions)):
		...
		<a class="my-acc-action" href="<?php echo esc_url($cancel_subscription['url']); ?>"
			class="button"><?php echo esc_html($cancel_subscription['name']); ?> Subscription</a>
	<?php endif; ?>

</div>

<h3 class="my-acc-section-header woocommerce-order-details__title">
	<?php esc_html_e('Subscription totals', 'woocommerce'); ?></h3>
<?php
...
<div>
	...
	<p class="mb-0"><span>Shipping: </span>$<?php echo $subscription_shipping_cost; ?> via
		<?php echo $subscription_shipping_method; ?></p>
