            ...
            <div class="mini-cart-wrapper">
               ...
               foreach ($cart->get_cart() as $cart_item_key => $cart_item) {
                  ...
                  if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key)) {
                     ...
                     ?>
                     <input type="hidden" hidden id="product-price-<?php echo $product_id; ?>"
                        class="<?php echo $productType; ?>" value="<?php echo $productPriceDiscounted; ?>">
                     <input type="hidden" hidden class="id-<?php echo $product_id; ?> <?php echo $productType; ?>"
                        ...
                        <div class="cart-product-qty-price">
                           <div class="cart-product-quantity">
                              <div class="add-to-cart-button">
                                 <div data-productid="<?php echo $product_id; ?>"
                                    data-product-type="<?php echo $productType; ?>" data-operator="remove"
                                    class="remove remove-final">-</div>
                                 <div
                                    class="product-quantity product-quantity-<?php echo $product_id; ?> <?php echo $productType; ?> fontBold">
                                    <?php echo $product_quantity; ?>
                                 </div>
                                 <div data-productid="<?php echo $product_id; ?>"
                                    data-product-type="<?php echo $productType; ?>" data-operator="add" class="add add-final">
                                    +</div>
                              </div>
                           </div>
         ...
         <div class="d-lg-none">
            <div class="revCoupons mobile shipping-step-order-summary">
               ...
               <form class="checkout_coupon woocommerce-form-coupon" method="post">
                  <p class=""><?php esc_html_e('If you have a promo code, please apply it below.', 'woocommerce'); ?>
                  </p>
                  <p class="form-row form-row-first">
                     <input type="text" name="coupon_code" class="input-text"
                        placeholder="<?php esc_attr_e('Promo code', 'woocommerce'); ?>" id="coupon_code" value="" />
                  </p>
                  <p class="form-row form-row-last">
                     <button type="submit" class="button applyCoupon" name="apply_coupon"
                        value="<?php esc_attr_e('Apply promo code', 'woocommerce'); ?>"><?php esc_html_e('Apply promo code', 'woocommerce'); ?></button>
                  </p>
                  <div class="clear"></div>
               </form>
            </div>
         ...
         <div class="shipping-and-delivery">
            <form name="checkout" method="post" class="checkout woocommerce-checkout"
               ...
               <div class="payment-node">
                  ...
                  <div class="checkout-bottom-logos-wrapper-mobile d-lg-none">
                     ...
                     <img class="payments-mobile" alt="Payment methods"
            ...
            <div class="d-none d-lg-block">
               <div class="revCoupons desktop-coupons order-summary-containerTest shipping-step-order-summary mb-5">
                  ...
                  <form class="checkout_coupon woocommerce-form-coupon" method="post">
                     <p class="">
                        <?php esc_html_e('If you have a promo code, please apply it below.', 'woocommerce'); ?>
                     </p>
                     <p class="form-row form-row-first">
                        <input type="text" name="coupon_code" class="input-text"
                           placeholder="<?php esc_attr_e('Promo code', 'woocommerce'); ?>" id="coupon_code" value="" />
            ...
            <div class="mobile-shipping-node">
               <div class="pay-button-and-cards-logos-wrapper">
                  <button class="review-and-pay-button blue-button button-font trigger-validation">REVIEW AND
                     PAY</button>
