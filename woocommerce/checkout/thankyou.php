				...
				<div class="col-6 left-column">
					<div class="subscribe">
						...
						<form class="newsletter-form"
							action="https://revelationnootropics.us1.list-manage.com/subscribe/post-json" method="POST">
							...
							<input class="black-input newsletter-email-input" type="email" autocapitalize="off"
								autocorrect="off" name="EMAIL" id="EMAIL" size="25" value="" placeholder="Email">
				...
				<div class="col-12 col-lg-6 right-column">
					...
					<div class="thank-you-content sitePadding mobile">
						...
						if ($order->get_payment_method() == "zelle") {
							?>
							<p>This is NOT your payment receipt. A confirmation email will be sent to you once your payment is
								processed.</p>
							<div class="zelle-pay-info-wrapper">
								...
								<p>Payment method: <strong
										style="text-transform: capitalize;"><?php echo $paymentMethod; ?></strong></p>
							</div>
							<h4>ZELLE NOTICE</h4>
							<p>Please use only your order number (available once you have placed your order) as the payment
								reference in the Comments or Notes section. Once we have received your payment, we will send you a
								confirmation email within 24-48 hours to confirm the successful processing of your order. This is a
								BUSINESS (NOT personal) Zelle account.</p>
							<?php
							...
							<p>Please use the Zelle information, QR code or payment button below, along with the order number as the
								memo:</p>
							...
							<div class="zelle-input-copy-wrapper">
								...
								<svg data-type="zelle__email" class="clipboard" width="17" height="21" viewBox="0 0 17 21"
									fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
										d="M2 20.3818C1.45 20.3818 0.979002 20.1858 0.587002 19.7938C0.195002 19.4018 -0.000664969 18.9311 1.69779e-06 18.3818V5.38178C1.69779e-06 5.09844 0.0960018 4.86078 0.288002 4.66878C0.480002 4.47678 0.717335 4.38111 1 4.38178C1.28334 4.38178 1.521 4.47778 1.713 4.66978C1.905 4.86178 2.00067 5.09911 2 5.38178V18.3818H12C12.2833 18.3818 12.521 18.4778 12.713 18.6698C12.905 18.8618 13.0007 19.0991 13 19.3818C13 19.6651 12.904 19.9028 12.712 20.0948C12.52 20.2868 12.2827 20.3824 12 20.3818H2ZM6 16.3818C5.45 16.3818 4.979 16.1858 4.587 15.7938C4.195 15.4018 3.99934 14.9311 4 14.3818V2.38178C4 1.83178 4.196 1.36078 4.588 0.968776C4.98 0.576776 5.45067 0.38111 6 0.381777H15C15.55 0.381777 16.021 0.577777 16.413 0.969777C16.805 1.36178 17.0007 1.83244 17 2.38178V14.3818C17 14.9318 16.804 15.4028 16.412 15.7948C16.02 16.1868 15.5493 16.3824 15 16.3818H6ZM6 14.3818H15V2.38178H6V14.3818Z"
										fill="black" />
							...
							<div class="zelle-input-copy-wrapper">
								<input id="zelle__orderNumber" class="zelle-info" type="text" value="<?php echo $orderNumber; ?>"
									disabled>
								<svg data-type="zelle__orderNumber" class="clipboard" width="17" height="21" viewBox="0 0 17 21"
									fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
										d="M2 20.3818C1.45 20.3818 0.979002 20.1858 0.587002 19.7938C0.195002 19.4018 -0.000664969 18.9311 1.69779e-06 18.3818V5.38178C1.69779e-06 5.09844 0.0960018 4.86078 0.288002 4.66878C0.480002 4.47678 0.717335 4.38111 1 4.38178C1.28334 4.38178 1.521 4.47778 1.713 4.66978C1.905 4.86178 2.00067 5.09911 2 5.38178V18.3818H12C12.2833 18.3818 12.521 18.4778 12.713 18.6698C12.905 18.8618 13.0007 19.0991 13 19.3818C13 19.6651 12.904 19.9028 12.712 20.0948C12.52 20.2868 12.2827 20.3824 12 20.3818H2ZM6 16.3818C5.45 16.3818 4.979 16.1858 4.587 15.7938C4.195 15.4018 3.99934 14.9311 4 14.3818V2.38178C4 1.83178 4.196 1.36078 4.588 0.968776C4.98 0.576776 5.45067 0.38111 6 0.381777H15C15.55 0.381777 16.021 0.577777 16.413 0.969777C16.805 1.36178 17.0007 1.83244 17 2.38178V14.3818C17 14.9318 16.804 15.4028 16.412 15.7948C16.02 16.1868 15.5493 16.3824 15 16.3818H6ZM6 14.3818H15V2.38178H6V14.3818Z"
										fill="black" />
						...
						<?php } elseif ($order->get_payment_method() == "redirect") { ?>
							<p>Within the next 24 hours, you will receive an email containing the payment link and invoice necessary
								for completing your order payment via credit/debit card. Upon successful payment, a confirmation
								email will be sent to you, along with your tracking number.</p>
						<?php } else { ?>
						...
						<p class="bold">Feel free to visit the main <a href="<?php the_field('faq_link', 'option') ?>"><u
									class="bold">frequently asked questions</u></a> page if you have any other queries or need
							more information.</p>
					</div>
				</div>
			</div>
