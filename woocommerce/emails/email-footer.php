		...
		<table border="0" cellpadding="10" cellspacing="0" width="100%" id="template_footer">
			<tr class="desktop-footer">
				<td class="email-column revelations-logo-wrapper" valign="bottom">
					<img src="<?php echo get_template_directory_uri(); ?>/img/emails/nootropics-logo.png"
						alt="Revelations Nootropics logo">
				</td>
				<td class="email-column" valign="bottom">
					<div class="social-icons-wrapper">
						<img src="<?php echo get_template_directory_uri(); ?>/img/emails/fb-icon.png"
							alt="Facebook logo">
						<img src="<?php echo get_template_directory_uri(); ?>/img/emails/ig-icon.png"
							alt="Instagram logo">
						<img src="<?php echo get_template_directory_uri(); ?>/img/emails/twitter-icon.png"
							alt="Twitter logo">
					</div>
				</td>
