...
<div class="sitePadding mild-gray-bck headerPadding content">
   ...
   <p>
      ...
      a purchase from wukiyo.com (the “Site”).
   </p>
   <p class="fontBold my-4">
   ...
   <p>We collect Device Information using <br>
   ...
   <p>Additionally when you make a purchase or attempt to make a purchase through the Site, we collect certain
      ...
      credit card numbers), email address, and phone number. We refer to this information
      as “Order Information”.
   </p>
   <p>When we talk about “Personal
      Information” in this Privacy Policy, we are talking both about Device Information and Order Information.
   </p>
   ...
   <p>Additionally, we use this Order Information to: <br>
      Communicate with you; <br>
      Screen our orders for potential risk <br>
      or fraud; and <br>
      When in line with the preferences you have shared with us, provide you with information or advertising relating to
      our products or services.
   </p>
   <p>We use the Device Information that we collect to help us screen for potential risk and fraud (in particular, your
   ...
   <p>For example, we use Stripe to power our online store. You can read more about how Stripe uses your Personal
      Information here: <a class="underlined_link" target="_blank"
         href="https://stripe.com/gb/privacy">https://stripe.com/gb/privacy</a> </p>
   <p>We also use Google Analytics to help us understand how our customers use the Site. You can read more about how
      Google uses your Personal Information here: https://www.google.com/intl/en/policies/privacy/.
      You can also opt-out of Google Analytics here: https://tools.google.com/dlpage/gaoptout.
   </p>
   <p>Finally, we may also share your Personal Information to comply with applicable laws and regulations, to respond to
      a subpoena, search warrant or other lawful request for information we receive,
   ...
   <p>As described above, we use your Personal Information to provide you with targeted advertisements or marketing
      ...
      you can visit the Network Advertising Initiative’s (“NAI”) educational page at <a class="underlined_link"
         target="_blank"
   ...
   <p>
      ...
      Facebook:<a class="underlined_link" target="_blank" href=" https://www.facebook.com/settings/?tab=ads">
         https://www.facebook.com/settings/?tab=ads</a> <br>
      Google:
      <a class="underlined_link" target="_blank"
         href="https://www.facebook.com/settings/?tab=ads">https://www.facebook.com/settings/?tab=ads</a>
   </p>
   <p>Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance’s opt-out
      portal at: <a class="underlined_link" target="_blank" href=" http://optout.aboutads.info/">
         http://optout.aboutads.info/</a>.</p>
   <p class="fontBold my-4">
      Do not track
   </p>
   <p>Please note that we do not alter
   ...
   <p>Additionally, if you are a European resident we note that we are processing your information in order to fulfill
      ...
      outside of Europe, including to Canada and the United States.</p>
   <p class="fontBold my-4">
      Data retentionghts
   </p>
   <p>When you place an order through the Site, we will maintain your Order Information for our records unless and until
      you ask us to delete this information.</p>
   <p class="fontBold my-4">
      Changes
   </p>
   <p>We may update this privacy policy <br>
      from time to time in order to reflect, <br>
      for example, changes to our practices <br>
      or for other operational, <br>
